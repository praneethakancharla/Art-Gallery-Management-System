                    ...
                    <div class="col-md-4 card-container">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body">
                                ...
                                <a href="editArtDetails.php?art_id=' . $row['product_id'] . '" class="btn btn-primary" target ="content_page">Edit</a>
                                <a href="deleteArt.php?art_id=' . $row['product_id'] . '" class="btn btn-danger ms-2" onclick="return confirm(\'Are you sure you want to delete this art piece?\')">Delete</a>
                            </div>
                        </div>
                    </div>';
                }
